...
namespace Dumble.RecommendationService.API.Authentication;
...
internal sealed class RolesClaimsTransformation : IClaimsTransformation
{
    public Task<ClaimsPrincipal> TransformAsync(ClaimsPrincipal principal)
    {
        ...
        // Snapshot first: AddClaim mutates identity.Claims, which FindAll enumerates
        // lazily — iterating the live result while adding throws "Collection modified".
