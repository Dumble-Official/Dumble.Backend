...
/**
 * Pre-built WebClient beans for sibling services Wallet calls. Currently
 * only Payment (Decision 1.3 — Wallet doesn't talk to Paymob; it asks
 * Payment to execute withdrawals).
 */
@Configuration
